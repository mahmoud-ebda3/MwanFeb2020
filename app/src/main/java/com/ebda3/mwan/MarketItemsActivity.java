...
import com.ebda3.adapters.PricesItemsListAdapter;
...
public class MarketItemsActivity extends AppCompatActivity {
    ...
    public String id,GID,Name,Location;


    PricesItemsListAdapter adapter ;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (array.length() > 0) {
                                ...
                                if (!setAdapterStatus)
                                {
                                    adapter = new PricesItemsListAdapter(context,ItemID,ItemName,ItemPhoto,ItemPrice,shippingCost,ItemAvailableAmount,ItemPartnerID,ItemPartnerName);
